/// Helper to format the text that gets thrown onto the chem hud element.  SKYRAPTOR EDIT: MNC maptext subtype
#define FORMAT_CHEM_CHARGES_TEXT(charges) MAPTEXT_MNC("<div align='center' valign='middle' style='position:relative; top:0px; left:6px'><font color='#dd66dd'>[round(charges)]</font></div>")
