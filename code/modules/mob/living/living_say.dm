...
GLOBAL_LIST_INIT(department_radio_keys, list(
	...
	// NK006 Department
	RADIO_KEY_NK6_COMMAND = RADIO_CHANNEL_NK6_COMMAND,
	RADIO_KEY_NK6_CMDSEC = RADIO_CHANNEL_NK6_CMDSEC,
	RADIO_KEY_NK6_SUPPORT = RADIO_CHANNEL_NK6_SUPPORT,
	RADIO_KEY_NK6_SUPENG = RADIO_CHANNEL_NK6_SUPENG,
	RADIO_KEY_NK6_SPECIALIST = RADIO_CHANNEL_NK6_SPECIALIST,
	RADIO_KEY_NK6_SPCMED = RADIO_CHANNEL_NK6_SPCMED,
	RADIO_KEY_NK6_ALLCRG = RADIO_CHANNEL_NK6_ALLCRG,
	RADIO_KEY_NK6_ALLSRV = RADIO_CHANNEL_NK6_ALLSRV,
	RADIO_KEY_NK6_ALLHEADS = RADIO_CHANNEL_NK6_ALLHEADS,
