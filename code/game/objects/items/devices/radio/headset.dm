...
GLOBAL_LIST_INIT(channel_tokens, list(
	...
	RADIO_CHANNEL_AI_PRIVATE = RADIO_TOKEN_AI_PRIVATE, //nk006 edit begin
	RADIO_CHANNEL_NK6_ALLHEADS = RADIO_TOKEN_NK6_ALLHEADS,
	RADIO_CHANNEL_NK6_COMMAND = RADIO_TOKEN_NK6_COMMAND,
	RADIO_CHANNEL_NK6_CMDSEC = RADIO_TOKEN_NK6_CMDSEC,
	RADIO_CHANNEL_NK6_SUPPORT = RADIO_TOKEN_NK6_SUPPORT,
	RADIO_CHANNEL_NK6_SUPENG = RADIO_TOKEN_NK6_SUPENG,
	RADIO_CHANNEL_NK6_SPECIALIST = RADIO_TOKEN_NK6_SPECIALIST,
	RADIO_CHANNEL_NK6_SPCMED = RADIO_TOKEN_NK6_SPCMED,
	RADIO_CHANNEL_NK6_ALLCRG = RADIO_TOKEN_NK6_ALLCRG,
	RADIO_CHANNEL_NK6_ALLSRV = RADIO_TOKEN_NK6_ALLSRV
))
