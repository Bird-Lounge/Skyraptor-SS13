...
/obj/item/healthanalyzer/attack(mob/living/M, mob/living/carbon/human/user)
	...
	if ((HAS_TRAIT(user, TRAIT_CLUMSY) || HAS_TRAIT(user, TRAIT_DUMB)) && prob(50))
		...
		to_chat(user, "[span_info("Analyzing results for The floor:\n\tOverall status: <b>Healthy</b>")]\
				\n[span_info("Key: <font color='#0066ff'>Suffocation</font>/<font color='#aaff00'>Toxin</font>/<font color='#ffcc33'>Burn</font>/<font color='#6600ff'>Brute</font>")]\
				\n[span_info("\tDamage specifics: <font color='#66cccc'>0</font>-<font color='#aaff00'>0</font>-<font color='#ff6600'>0</font>-<font color='#6600ff'>0</font>")]\
			...
			for(var/obj/item/organ/organ as anything in humantarget.internal_organs)
				...
				if (status != "")
					...
					toReport += "<tr><td><font color='#ff0000'>[organ.name]:</font></td>\
						[advanced ? "<td><font color='#6600ff'>[CEILING(organ.damage,1)]</font></td>" : ""]\
						<td>[status]</td></tr>"
			...
			if(length(missing_organs))
				...
				for(var/organ in missing_organs)
					toReport += "<tr><td><font color='#ff0000'>[organ]:</font></td>\
						[advanced ? "<td><font color='#6600ff'>["-"]</font></td>" : ""]\
