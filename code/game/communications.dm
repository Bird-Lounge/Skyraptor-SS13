...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_CTF_YELLOW = FREQ_CTF_YELLOW, //NK006 edit begin
	RADIO_CHANNEL_NK6_ALLHEADS = FREQ_NK6_ALLHEADS,
	RADIO_CHANNEL_NK6_COMMAND = FREQ_NK6_COMMAND,
	RADIO_CHANNEL_NK6_CMDSEC = FREQ_NK6_CMDSEC,
	RADIO_CHANNEL_NK6_SUPPORT = FREQ_NK6_SUPPORT,
	RADIO_CHANNEL_NK6_SUPENG = FREQ_NK6_SUPENG,
	RADIO_CHANNEL_NK6_SPECIALIST = FREQ_NK6_SPECIALIST,
	RADIO_CHANNEL_NK6_SPCMED = FREQ_NK6_SPCMED,
	RADIO_CHANNEL_NK6_ALLCRG = FREQ_NK6_ALLCRG,
	RADIO_CHANNEL_NK6_ALLSRV = FREQ_NK6_ALLSRV
))
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_CTF_YELLOW]" = RADIO_CHANNEL_CTF_YELLOW, //NK006 edit begin
	"[FREQ_NK6_ALLHEADS]" = RADIO_CHANNEL_NK6_ALLHEADS,
	"[FREQ_NK6_COMMAND]" = RADIO_CHANNEL_NK6_COMMAND,
	"[FREQ_NK6_CMDSEC]" = RADIO_CHANNEL_NK6_CMDSEC,
	"[FREQ_NK6_SUPPORT]" = RADIO_CHANNEL_NK6_SUPPORT,
	"[FREQ_NK6_SUPENG]" = RADIO_CHANNEL_NK6_SUPENG,
	"[FREQ_NK6_SPECIALIST]" = RADIO_CHANNEL_NK6_SPECIALIST,
	"[FREQ_NK6_SPCMED]" = RADIO_CHANNEL_NK6_SPCMED,
	"[FREQ_NK6_ALLCRG]" = RADIO_CHANNEL_NK6_ALLCRG,
	"[FREQ_NK6_ALLSRV]" = RADIO_CHANNEL_NK6_ALLSRV
))
