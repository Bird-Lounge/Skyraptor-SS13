...
/datum/emote/living/carbon/claponce/get_sound(mob/living/user)
	if(ishuman(user))
		if(!user.get_bodypart(BODY_ZONE_L_ARM) || !user.get_bodypart(BODY_ZONE_R_ARM))
			...
			return pick('modular_nk006/modules/newemotes/sounds/claponce1.ogg',
							'modular_nk006/modules/newemotes/sounds/claponce2.ogg')
...
/datum/emote/living/carbon/cackle/get_sound(mob/living/user)
	if(ishuman(user))
		return pick('modular_nk006/modules/newemotes/sounds/voice/cackle_yeen.ogg')
...
/datum/emote/living/carbon/warble/get_sound(mob/living/user)
	if(ishuman(user))
		return pick('modular_nk006/modules/newemotes/sounds/voice/warble.ogg')
...
/datum/emote/living/carbon/wurble/get_sound(mob/living/user)
	if(ishuman(user))
		return pick('modular_nk006/modules/newemotes/sounds/voice/wurble.ogg')
...
/datum/emote/living/carbon/peep/get_sound(mob/living/user)
	if(ishuman(user))
		return pick('modular_nk006/modules/newemotes/sounds/voice/peep_once.ogg')
...
/datum/emote/living/carbon/peep2/get_sound(mob/living/user)
	if(ishuman(user))
		return pick('modular_nk006/modules/newemotes/sounds/voice/peep.ogg')
...
/datum/emote/living/carbon/hoot/get_sound(mob/living/user)
	if(ishuman(user))
		return pick('modular_nk006/modules/newemotes/sounds/voice/hoot.ogg')
...
/datum/emote/living/carbon/trill/get_sound(mob/living/user)
	if(ishuman(user))
		return pick('modular_nk006/modules/newemotes/sounds/voice/trills.ogg')
...
/datum/emote/living/carbon/moff/get_sound(mob/living/user)
	if(ishuman(user))
		return pick('modular_nk006/modules/newemotes/sounds/voice/mothsqueak.ogg')
...
/datum/emote/living/carbon/merp/get_sound(mob/living/user)
	if(ishuman(user))
		return pick('modular_nk006/modules/newemotes/sounds/voice/merp.ogg')
...
/datum/emote/living/carbon/weh/get_sound(mob/living/user)
	if(ishuman(user))
		return pick('modular_nk006/modules/newemotes/sounds/voice/weh.ogg')
...
/datum/emote/living/carbon/snap1/get_sound(mob/living/user)
	if(ishuman(user))
		if(!user.get_bodypart(BODY_ZONE_L_ARM) || !user.get_bodypart(BODY_ZONE_R_ARM))
			...
			return pick('modular_nk006/modules/newemotes/sounds/snap1.ogg')
...
/datum/emote/living/carbon/snap2/get_sound(mob/living/user)
	if(ishuman(user))
		if(!user.get_bodypart(BODY_ZONE_L_ARM) || !user.get_bodypart(BODY_ZONE_R_ARM))
			...
			return pick('modular_nk006/modules/newemotes/sounds/snap2.ogg')
...
/datum/emote/living/carbon/snap1/get_sound(mob/living/user)
	if(ishuman(user))
		if(!user.get_bodypart(BODY_ZONE_L_ARM) || !user.get_bodypart(BODY_ZONE_R_ARM))
			...
			return pick('modular_nk006/modules/newemotes/sounds/snap3.ogg')