/obj/machinery/light
	icon = 'modular_nk006/modules/aesthetics/lights/icons/lighting.dmi'
	overlay_icon = 'modular_nk006/modules/aesthetics/lights/icons/lighting_overlay.dmi'
...
/obj/machinery/light/proc/turn_on(trigger, play_sound = TRUE)
	...
	if(!matching)
		...
		if( prob( min(60, (switchcount**2)*0.01) ) )
			...
			set_light(BR, PO, CO)
			if(play_sound)
				playsound(src.loc, 'modular_nk006/modules/aesthetics/lights/sound/light_on.ogg', 65, 1)
