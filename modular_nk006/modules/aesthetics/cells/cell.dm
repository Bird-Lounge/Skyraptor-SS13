/obj/item/stock_parts/cell
	icon = 'modular_nk006/modules/aesthetics/cells/cell.dmi'
...
/obj/item/stock_parts/cell/update_overlays()
	...
	var/icon_link
	if(!grown_battery)
		icon_link = 'modular_nk006/modules/aesthetics/cells/cell.dmi'
	else
...
/obj/machinery/cell_charger/update_overlays()
	...
	if(!charging.charging_icon)
		...
		.+= image('modular_nk006/modules/aesthetics/cells/cell.dmi', charging.charging_icon)\
