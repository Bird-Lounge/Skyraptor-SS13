/obj/machinery/light_switch
	icon = 'modular_nk006/modules/aesthetics/lightswitch/icons/lightswitch.dmi'

/obj/machinery/light_switch/interact(mob/user)
	. = ..()
	playsound(src, 'modular_nk006/modules/aesthetics/lightswitch/sound/lightswitch.ogg', 100, 1)
