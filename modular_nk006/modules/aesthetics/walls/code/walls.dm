/turf/closed/wall
	icon = 'modular_nk006/modules/aesthetics/walls/icons/wall.dmi'
	canSmoothWith = SMOOTH_GROUP_WALLS + SMOOTH_GROUP_WINDOW_FULLTILE + SMOOTH_GROUP_AIRLOCK

/turf/closed/wall/r_wall
	icon = 'modular_nk006/modules/aesthetics/walls/icons/reinforced_wall.dmi'
...
/obj/structure/falsewall/material
	icon = 'modular_nk006/modules/aesthetics/walls/icons/material_wall.dmi'
	icon_state = "wall-0"
	base_icon_state = "wall"
