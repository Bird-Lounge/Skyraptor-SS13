...
/obj/machinery/door/airlock/keyed
	...
	icon = 'modular_nk006/modules/aesthetics/keyed_doors/icons/keyed.dmi'
	// overlays_file = 'modular_nk006/modules/aesthetics/keyed_doors/icons/keyed_overlays.dmi' // if this route is ever taken
	icon_state = "closed"
	explosion_block = 3
	heat_proof = TRUE
	density = TRUE
